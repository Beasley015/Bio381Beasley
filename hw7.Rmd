...
ggplot(data = spec.rich, aes(x = rank))+
  geom_point(aes(y = richness, color = "True"))+
  geom_smooth(aes(y = richness, color = "True"))+
  geom_point(aes(y = richness.1, color = "Observed"))+
  geom_smooth(aes(y = richness.1, color = "Observed"))+
  theme_bw()
